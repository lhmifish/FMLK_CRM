  ...
  */
	...
	function positionCalendar() {
		...
		var calendarHeight = self.calendarContainer.offsetHeight,
		    ...
		    //calendarWidth = window.document.body.offsetWidth,
		...
		self.calendarContainer.style.bottom = "20px";

		if (!rightMost) {
			//self.calendarContainer.style.left = left + "px";
			//self.calendarContainer.style.right = "auto";
			self.calendarContainer.style.right = (window.document.body.offsetWidth-calendarWidth)/2 +"px";
		} else {
			//self.calendarContainer.style.left = "auto";
			//self.calendarContainer.style.right = right + "px";
			self.calendarContainer.style.left = (window.document.body.offsetWidth-calendarWidth)/2 +"px";
		}
	}
