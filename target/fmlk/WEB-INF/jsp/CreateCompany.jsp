...
<script src="${pageContext.request.contextPath}/js/request.js?v=1"></script>
<style type="text/css">
a:hover {
	color: #FF00FF
} /* 鼠标移动到链接上 */
...
<script type="text/javascript">
	...
	function createCompany() {
		...
		var ret = post("createNewCompany",params,true);
		console.log(ret.code);
		console.log(ret.error);
		console.log(ret.error==null);
		...
		/* $.ajax({
			...
			success : function(returndata) {
				...
				}else if(data == 2 || data == 4 || data == 1){
					alert("客户录入提交失败,errcode="+data);
				}else{
