...
<script type="text/javascript">
	...
	function showMore(type) {
		...
		window.location.href = "${pageContext.request.contextPath}/page/moreAssignmentList/"
				+ type
	}
...
<body style="width: 100%; height: 100%">
	...
	<div style="width: 100%; height: 42px">
		<div class="column_numInfo" style="background: black;"
			onclick="showMore(1)">
			<a>未开始</a>
		</div>
		<div class="column_numInfo" style="background: red;"
			onclick="showMore(3)">
			<a>超时未完成</a>
		</div>
		<div class="column_numInfo" style="background: orange;"
			onclick="showMore(2)">
			<a>处理中</a>
		</div>
		<div class="column_numInfo" style="background: brown;"
			onclick="showMore(9)">
			<a>待销售确认</a>
		</div>
		<div class="column_numInfo" style="background: blue;"
			onclick="showMore(6)">
			<a>已完成(超时)</a>
		</div>
		<div class="column_numInfo" style="background: green;"
			onclick="showMore(5)">
			<a>已完成(正常)</a>
		</div>
		
		<div style="margin: 3px;margin-left: 10px; font-size: 12px; float: left;">
			<label>销售人员</label>
			<select id="saleUser" style="width: 80px;margin-left: 5px;"></select>
		</div>
		
		<div style="margin: 3px;margin-left: 10px; font-size: 12px; float: left;">
			<label>服务工程师</label>
			<select id="techUser" style="width: 80px;margin-left: 5px;"></select>
		</div>
		
		<div style="margin: 3px;margin-left: 10px; font-size: 12px; float: left;">
			<label>客户公司</label>
			<select id="company" style="width: 250px;margin-left: 5px;" class="js-example-basic-single" name="state"></select>
		</div>

        <div style="margin: 3px;margin-left: 10px; font-size: 12px; float: left;">
			<input type="button" value="查询"
				style="width: 60px;" onclick="query()" />
		</div>
		
		<div
			style="margin: 3px; color: blue; margin-right: 20px; font-size: 11px; float: right;"
			onclick="showMore(8)">
			<a>查看所有事务...</a>
		</div>
		<div
			style="margin: 3px; color: blue; margin-right: 25px; font-size: 11px; float: right;"
	...
	<div>
		<div class="am-avg-sm-4;am-avg-md-4 am-margin-xs am-text-center"
			...
			<div class="column_num">
				...
				<div style="float: right; color: blue; margin-right: 10px"
					id="more_1" onclick="showMore(3)">更多...</div>
			</div>
			<div class="column_num">
				<div style="float: left;">
				...
				<div style="float: right; color: blue; margin-right: 10px"
					id="more_2" onclick="showMore(9)">更多...</div>
			</div>
			<div class="column_num">
				<div style="float: left;">
				...
				<div style="float: right; color: blue; margin-right: 10px"
					id="more_3" onclick="showMore(4)">更多...</div>
			</div>
			<div class="column_num">
				<div style="float: left;">
				...
				<div style="float: right; color: blue; margin-right: 10px"
					id="more_4" onclick="showMore(7)">更多...</div>
			</div>
		</div>
