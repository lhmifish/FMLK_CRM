...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$(document).attr("title", getUser(uId).name + "的日程");
		...
		<div class="top" style="width: 100%">
			<div style="width: 100%; margin-bottom: 5px; margin-left: 5px;">
				<Strong>日期：</Strong> <input type="text" id="date"
					style="width: 120px" />
				<input type="button" value="所有日程查询" onclick="toDailyArrangementList()" style="background-color: #459BFE;
	                color: #FFF;width:auto;text-align: center;float: right;margin-right:50px; vertical-align:middle ;
