...
<script type="text/javascript">
	...
	function getProjectCaseList(mPage) {
		...
		page = mPage;
		setTimeout(function() {
			get("projectCaseUnPatchList", {"unPatch" : 0}, false)
						...
						if (i >= 10 * (mPage - 1)
							...
							str += '<tr style="width: 100%"><td style="width: 8%" class="tdColor2">'
									...
									+ data[i].serviceDate.substring(11,
											16)
									+ '</span></td>'
									+ '<td style="width:8%" class="tdColor2"><span style="color:red">销售未审核</span></td>'
									+ '<td style="width:8%;font-size:14px" class="tdColor2">'
									+ data[i].createDate.substring(0,
											10)
									+ '</td>'
									+ '<td style="width:8%" class="tdColor2">'
									+ '<img name="img_edit" title="审核" style="vertical-align:middle" class="operation delban" src="../image/update.png" onclick="toEditProjectCasePage('
									+ data[i].id
									+ ',1)"><a name="a_edit" style="vertical-align:middle" onclick="toEditProjectCasePage('
									+ data[i].id
									+ ',1)">审核</a></td></tr>';
						}
					}
		...
		<div class="pageTop">
			<div class="page">
				<img src="../image/coin02.png" /><span><a href="#">首页</a>&nbsp;-&nbsp;<a
					href="#">派工管理</a>&nbsp;-&nbsp;<a href="#">派工单审核</a>&nbsp;-</span>&nbsp;销售审核
			</div>
		</div>
