...
<body>
	...
	<div class="page-wrapper">
		...
		<section class="page-title"
			style="background-image: url(${pageContext.request.contextPath}/assets/images/background/bg-14.jpg);">
			<div class="auto-container">
		...
		<section class="services-details">
			<div class="auto-container">
				<!--<div class="row">
					<div class="col-lg-8 ">
						<h2>共享陪护床app 扫码打开折叠床</h2>
						<div class="text">
						共享陪护床app开发的功能如下：
						<p>1、扫码解锁<br/>找到共享陪护床，使用共享陪护床app扫码开启解锁，也可以通过共享陪护床小程序来使用微信扫码解锁，解锁后就可以直接拉开折叠床使用。</p>
						</div>
						<div class="text">
						<p>2、可按时/按次计费<br/>共享陪护床按照使用时长或次数进行费用计算，比较灵活，时间计算精准。</p>
						</div>
						<div class="text">
						<p>3、第三方授权免密结账<br/>微信和支付宝信用授权支持免密免押使用。</p>
						</div>
						<div class="text">
						<p>共享陪护床给医院提供了一个很好的解决方案，提供床位给陪护人员，方便陪护人员守在病人身边随时进行照顾，使用方便，又便于管理，不占用太大空间。对于住院患者的家属来说，极大的方便了陪护患者；对于医院来说，缓解了无人陪护的压力；对于病房的空间来说，高效的利用了占地空间。</p>
						</div>
						
						</div>
                    </div>
				
				<div class="col-lg-4 content-side order-lg-2" >
                    <div class="image"><img src="${pageContext.request.contextPath}/assets/images/resource/image_37.jpg" alt=""></div>
                </div>
				...
				<div class="row">
					<div class="col-lg-8 content-side order-lg-2">
						<h2>产品优势</h2>
						<div class="text">
						<h2 style="font-size:30px;">➤产品定制化、个性化服务</h2>
						<p style="margin-left:50px">根据医院病房的实际需求，定制产品尺寸、规格及外观 </p>
						</div>
					
					    <div class="text">
						<h2 style="font-size:30px;">➤驻场人员现场运维</h2>
						<p style="margin-left:50px">现场维护人员解决产品的清洁、维修、归还等现场问题，避免影响医护日常工作 </p>
						</div>
						
						 <div class="text">
						<h2 style="font-size:30px;">➤产品具有安全认证、并投保意外险</h2>
						<p style="margin-left:50px">产品均经国家检测机构安全认证，保障安全使用，并由保险公司承保，解决医院的后顾之忧</p>
						</div>
						...
						<div class="service-sidebar">
							<div class="widget widget_categories_two">
								<div class="widget-content">
									<ul>
										<li><a
											href="${pageContext.request.contextPath}/aboutApp">产品介绍</a></li>
										<li class="current"><a
											href="${pageContext.request.contextPath}/appAdvantage">产品优势</a></li>										
									</ul>
								</div>
